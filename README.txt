...
Pour lancer le RMI : java -jar forms.jar -s
(RMI Save ou RMI Load in save selection + RMI Save/Load button : localhost)
Pour lancer l'affichage terminal : java -jar forms.jar -t
